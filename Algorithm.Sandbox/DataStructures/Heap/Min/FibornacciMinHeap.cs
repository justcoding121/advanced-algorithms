...
{
    public class FibornacciTreeNode<T> : IComparable where T : IComparable
    {
        internal T Value { get; set; }

        internal int Degree;
        internal FibornacciTreeNode<T> ChildrenHead { get; set; }

        internal FibornacciTreeNode<T> Parent { get; set; }
        internal bool LostChild { get; set; }

        internal FibornacciTreeNode<T> Previous;
        internal FibornacciTreeNode<T> Next;

        public FibornacciTreeNode(T value)
        {
            this.Value = value;
        }
        ...
        {
            return this.Value.CompareTo((obj as FibornacciTreeNode<T>).Value);
        }
    }

    public class AsFibornacciMinHeap<T> where T : IComparable
    {
        internal FibornacciTreeNode<T> heapForestHead;

        //holds the minimum node at any given time
        private FibornacciTreeNode<T> minNode = null;
        ...
        public FibornacciTreeNode<T> Insert(T newItem)
        {
            var newNode = new FibornacciTreeNode<T>(newItem);
        ...
        private void Meld()
        {
            ...
            var mergeDictionary = new Dictionary<int, FibornacciTreeNode<T>>();
        ...
        public void DecrementKey(FibornacciTreeNode<T> node)
        {
        ...
        private void Cut(FibornacciTreeNode<T> node)
        {
        ...
        private void MergeForests(FibornacciTreeNode<T> headPointer)
        {
        ...
        private void InsertNode(ref FibornacciTreeNode<T> head, FibornacciTreeNode<T> newNode)
        {
        ...
        private void DeleteNode(ref FibornacciTreeNode<T> heapForestHead, FibornacciTreeNode<T> deletionNode)
        {
