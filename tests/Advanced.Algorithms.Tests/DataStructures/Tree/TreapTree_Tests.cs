...
namespace Advanced.Algorithms.Tests.DataStructures
{
    ...
    public class TreapTreeTests
    {
        ...
        public void TreapTree_BulkInit_Test()
        {
            ...
            var tree = new TreapTree<int>(sortedNumbers);
        ...
        [TestMethod]
        public void TreapTree_Accuracy_Test()
        {
            var nodeCount = 1000;
        ...
        [TestMethod]
        public void TreapTree_Stress_Test()
        {
        ...
        [TestMethod]
        public void TreapTree_SortedSet_Oracle()
        {
