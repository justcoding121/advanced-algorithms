...
namespace Advanced.Algorithms.Tests.DataStructures
{
    ...
    public class AvlTreeTests
    {
        ...
        [TestMethod]
        public void AVLTree_Empty_SingleNode_DeleteRoot_Enumerate()
        {
            var tree = new AvlTree<int>();
        ...
        [TestMethod]
        public void AVLTree_Index_Next_Desc_Duplicate()
        {
            var tree = new AvlTree<int>();
            ...
            var fromSorted = new AvlTree<int>(new[] { 1, 2, 3, 4 });
            Assert.AreEqual(4, fromSorted.Count);
            Assert.AreEqual(1, fromSorted.FindMin());
            Assert.AreEqual(4, fromSorted.FindMax());
            Assert.IsTrue(fromSorted.Contains(3));
            Assert.IsFalse(fromSorted.Contains(99));
        }

        [TestMethod]
        public void AVLTree_SortedSet_Oracle()
        {
