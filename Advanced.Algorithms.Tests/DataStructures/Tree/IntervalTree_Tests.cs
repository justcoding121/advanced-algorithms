...
namespace Advanced.Algorithms.Tests.DataStructures
{
    ...
    public class IntervalTree_Tests
    {
        ...
        {
            var intTree = new IntervalTree<int>(1);
        ...
        public void IntervalTree_1D_Accuracy_Test()
        {
            ...
            for (int i = 0; i < nodeCount; i++)
            {
                ...
                var interval = new Interval<int>(new int[] { start }, new int[] { start + rnd.Next(1, 10) });
        ...
        public void IntervalTree_2D_Accuracy_Test()
        {
            ...
            for (int i = 0; i < nodeCount; i++)
            {
                ...
                //(x1,y1) and (x2, y2)
                var interval = new Interval<int>(new int[dimension] { startx, starty },
